 ...
 * (the classic "0.1 + 0.2 != 0.3" bug). Dinero is immutable: every
...
final class Dinero
{
    ...
    /**
     * Build a Dinero from a decimal string (e.g. "10.99") without float drift.
    ...
    private function ensureSameCurrency(self $other): void
    {
        if ($this->currency !== $other->currency) {
            throw new MonedaDistintaException($this->currency, $other->currency);
        }
    }
}
