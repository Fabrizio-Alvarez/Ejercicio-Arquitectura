...
const REGLAS = [
    ...
    { test: /fruta|manzana|banana|naranja|pera|uva|sandía|melón/i, emoji: '🍎' },
    { test: /carne|res|vaca|lomo|milanesa|bife/i, emoji: '🥩' },
    { test: /pollo|ave|pavo/i, emoji: '🍗' },
    { test: /pescado|merluza|salmón|atún/i, emoji: '🐟' },
    { test: /bebida|gaseosa|coca|sprite|fanta|agua|jugo/i, emoji: '🥤' },
    { test: /vino|cerveza|alcohol|champán|whisky/i, emoji: '🍷' },
